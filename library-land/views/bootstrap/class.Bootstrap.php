...
class SeedDMS_Bootstrap_Style extends SeedDMS_View_Common {
	...
	function htmlStartPage($title="", $bodyClass="", $customJS = "") { /* begin function */ //RR mod for custom JS) { /* begin function */
		echo "<!DOCTYPE html>\n";       
		echo "<html lang=\"en\">\n<head>\n";
		echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />\n";
		echo '<meta name="viewport" content="width=device-width, initial-scale=1.0">'."\n";
		echo '<link href="../styles/'.$this->theme.'/bootstrap/css/bootstrap.css?version=1.0" rel="stylesheet">'."\n";
		echo '<link href="../styles/'.$this->theme.'/application.css?version=1.0" rel="stylesheet">'."\n";
        ...
        if ($customJS > "") { //RR added
            echo "<script type='text/javascript'>" . $customJS . "</script>\n";
        }
        //RR added param to force favicon refresh
		echo '<link rel="shortcut icon" href="../styles/'.$this->theme.'/favicon.ico?version=1.0" type="image/x-icon"/>'."\n";
...
<?php
	...
	function htmlAddHeader($head) { /* begin function */
		$this->extraheader .= $head;
	} /* end function */

	function htmlEndPage() { /* begin function */
		$this->footNote();
		if($this->params['showmissingtranslations']) {
			$this->missingLanguageKeys(); //RR was missingḺanguageKeys
		}
		...
		echo '<script src="../styles/'.$this->theme.'/application.js?version=1.0"></script>'."\n";
		echo "</body>\n</html>\n";
	} /* end function */

	function missingLanguageKeys() { /* begin function */ //RR was missingḺanguageKeys
...
<?php
	...
	function footNote() { /* begin function */
		echo '<div class="row-fluid" style="padding-top: 20px;">'."\n";
		echo '<div class="span12">'."\n";
        //RR added
        echo "<div class='acknowledgments'>";
        echo getMLtext('arbmis_acknowledgements');
        echo "<br/>";
        echo "<img src='images/logo_cep.jpg' width='170px' height='60px' class='sponsors_logos' alt='CEP logo' title='Critical Ecosystem Partnership Fund'/>";
        echo "<img src='images/logo_jrs.jpg' width='158px' height='60px' class='sponsors_logos' alt='JRS logo' title='JRS Biodiversity Foundation'/>";
        echo "<img src='images/logo_maf.jpg' width='170px' height='60px' class='sponsors_logos' alt='MAF logo' title='MacArthur Foundation'/>";
        echo "<img src='images/logo_sdc.jpg' width='129px' height='60px' class='sponsors_logos' alt='SDC logo' title='Swiss Agency for Development and Cooperation'/>";
        echo "</div>";
		...
		if (isset($this->params['footnote']) && strlen((string)$this->params['footnote'])>0) {
            //RR modified to include footNoteText div
			echo "<div class=\"footNote\"><div class=\"footNoteText\">".(string)$this->params['footnote']."</div></div>";
		}
		echo "</div>\n";
		echo "</div>\n";
		echo "</div>\n";
	...
	function contentStart() { /* begin function */
		echo "<div class=\"container-fluid\">\n";
		echo " <div class=\"row-fluid\">\n";
	} /* end function */

	function contentEnd() { /* begin function */
		echo " </div>\n";
		echo "</div>\n";
	} /* end function */

	function globalBanner() { /* begin function */
        echo "<div class='banner-top'></div>"; //RR added
		echo "<div class=\"navbar navbar-inverse navbar-fixed-top\">\n";
		echo " <div class=\"navbar-inner\">\n";
		echo "  <div class=\"container\">\n";
		//RR modified to use sitename as link to dashboard, and separate root folders link (effective change seems to be in globalNavigation below?)
        ...
        echo "   <a class=\"brand\" href=\"../..\">" . getMLText('arcos_biodiversity_management_information_system') . "</a>\n";
        echo "   </div></div>\n";
        echo " <div class=\"navbar-inner\">\n";
        echo "  <div class=\"container\">\n";               
		echo "   <a class=\"brand\" href=\"../out/out.Dashboard.php\">".(strlen($this->params['sitename'])>0 ? $this->params['sitename'] : "SeedDMS")."</a>\n";
		//RR end
		echo "  </div>\n";
		echo " </div>\n";
		echo "</div>\n";
	...
	function menuClipboard($clipboard) { /* begin function */
		$content = '';
		...
		if(isset($this->params['folder']) && $this->params['folder']->getAccessMode($this->params['user']) > M_READWRITE) { /* RR was >= */
	...
	function globalNavigation($folder=null) { /* begin function */
        echo "<div class='banner-top'></div>"; //RR added
		echo "<div class=\"navbar navbar-inverse navbar-fixed-top\">\n";
		echo " <div class=\"navbar-inner\">\n";
		echo "  <div class=\"container\">\n";
		...
		echo "     <span class=\"icon-bar\"></span>\n";
		echo "   </a>\n";
		//RR modified to use sitename as link to dashboard, and separate root folders link 
		//echo "   <a class=\"brand\" href=\"../out/out.ViewFolder.php?folderid=".$this->params['rootfolderid']."\">".(strlen($this->params['sitename'])>0 ? $this->params['sitename'] : "SeedDMS")."</a>\n";
		//echo "   <a class=\"brand\"  style=\"padding-right:0.5em\" href=\"../../\">ARBIMS</a>";
        echo "   <a class=\"brand\" href='../..'>" . getMLText('arcos_biodiversity_management_information_system') . "</a>\n";
        echo "   <ul class=\"nav\">\n";
        echo "     <li><a href='../..'>&laquo; " . getMLtext('main_portal_home') . "</a></li>\n";
        echo "   </ul>\n";
        echo "   </div></div>\n";
        echo " <div class=\"navbar-inner\">\n";
        echo "  <div class=\"container\">\n";        
		...
		if(isset($this->params['user']) && $this->params['user']) {
			...
			echo "   <ul class=\"nav\">\n";
			echo "    <li id=\"first\"><a href=\"../out/out.ViewFolder.php?folderid=".$this->params['rootfolderid']."\">".getMLText("folders")."</a></li>\n"; //RR was commented out
            ...
            //RR was 150px but trying to get French menu to fit on one line :/
			echo "      <input name=\"query\" class=\"search-query\" id=\"searchfield\" data-provide=\"typeahead\" type=\"text\" style=\"width: 100px;\" placeholder=\"".getMLText("search")."\"/>";
	...
	//		echo "      <input type=\"submit\" value=\"".getMLText("search")."\" id=\"searchButton\" class=\"btn\"/>";
			echo "</form>\n";
            //RR include 'advanced search' link		
            //echo "<ul class=\"nav\">\n<li><a href=\"../out/out.AdvancedSearch.php\">".getMLText("advanced_search")."</a></li>\n</ul>";
			echo "    </div>\n";
		}
		echo "  </div>\n";
		echo " </div>\n";
	...
	function getFolderPathHTML($folder, $tagAll=false, $document=null) { /* begin function */
		$path = $folder->getPath();
		$txtpath = "";
	...
	function pageNavigation($pageTitle, $pageType=null, $extra=null) { /* begin function */
	...
	private function folderNavigationBar($folder) { /* begin function */
		...
		if ($accessMode == M_READ && !$this->params['user']->isGuest()) {
			echo "<li id=\"first\"><a href=\"../out/out.FolderNotify.php?folderid=". $folderID ."&showtree=".showtree()."\">".getMLText("edit_folder_notify")."</a></li>\n";
                        ...
                        if ($accessMode > M_READWRITE) /* RR only admins can create folders */
			...
			if ($accessMode > M_READWRITE) /* RR only admins can do this */
	...
	private function documentNavigationBar($document)	{ /* begin function */
		...
		if ($accessMode == M_ALL) {
                    if ($this->params['user']->isAdmin()) { /* RR added - doc owners cant modify the settings below */
	...
	private function accountNavigationBar() { /* begin function */
	...
	private function myDocumentsNavigationBar() { /* begin function */
	...
	private function adminToolsNavigationBar() { /* begin function */
	...
	private function calendarNavigationBar($d){ /* begin function */
	...
	function pageList($pageNumber, $totalPages, $baseURI, $params) { /* begin function */
	...
	function contentContainer($content) { /* begin function */
		echo "<div class=\"well\">\n";
		echo $content;
		echo "</div>\n";
		return;
	...
	function contentContainerStart($type='info') { /* begin function */
	...
	function contentContainerEnd() { /* begin function */

		echo "</div>\n";
		return;
	} /* end function */

	function contentHeading($heading, $noescape=false) { /* begin function */
	...
	function contentSubHeading($heading, $first=false) { /* begin function */
...
//		echo "<div class=\"contentSubHeading\"".($first ? " id=\"first\"" : "").">".htmlspecialchars($heading)."</div>\n";
	...
	function getMimeIcon($fileType) { /* begin function */
	...
	function printDateChooser($defDate = -1, $varName) { /* begin function */
	...
	function printSequenceChooser($objArr, $keepID = -1) { /* begin function */
		if (count($objArr) > 0) {
	...
	function printDocumentChooser($formName) { /* begin function */
...
<?php
	...
	function printFolderChooser($formName, $accessMode, $exclude = -1, $default = false) { /* begin function */
...
<?php
	...
	function printCategoryChooser($formName, $categories=array()) { /* begin function */
?>
<script language="JavaScript">
...
<?php
	...
	function printKeywordChooser($formName, $keywords='', $fieldname='keywords') { /* begin function */
?>
...
<?php
	...
	function printAttributeEditField($attrdef, $objvalue, $fieldname='attributes') { /* begin function */
		if($valueset = $attrdef->getValueSetAsArray()) {
			...
			echo ">";
			if ($attrdef->getMinValues() < 1) { //RR added, removed following line - keep consistent with inc.ClassUI_Default
			//if(!$attrdef->getMultipleValues()) {			
    ...
    //RR added for search function to be able to force a drop-down on multi-value attributes
    function printAttributeSingleSelect($attrdef, $objvalue, $fieldname='attributes') { /* begin function */
		if($valueset = $attrdef->getValueSetAsArray()) {
			echo "<select name=\"".$fieldname."[".$attrdef->getId()."]\">";
	...
	function printDropFolderChooser($formName, $dropfolderfile="") { /* begin function */
		print "<div class=\"input-append\">\n";
...
<?php
	...
	function getImgPath($img) { /* begin function */
	...
	function printImgPath($img) { /* begin function */
		print $this->getImgPath($img);
	} /* end function */

	function infoMsg($msg) { /* begin function */
		echo "<div class=\"alert alert-info\">\n";
		echo $msg;
		echo "</div>\n";
	} /* end function */

	function warningMsg($msg) { /* begin function */
		echo "<div class=\"alert alert-warning\">\n";
		echo $msg;
		echo "</div>\n";
	} /* end function */

	function errorMsg($msg) { /* begin function */
		echo "<div class=\"alert alert-error\">\n";
		echo $msg;
		echo "</div>\n";
	} /* end function */

	function exitError($pagetitle, $error, $noexit=false) { /* begin function */
	 ...
	 *   as well.
	 */
	function printNewTreeNavigation($folderid=0, $accessmode=M_READ, $showdocs=0, $formid='form1', $expandtree=0, $orderby='') { /* begin function */
...
<?php
	...
	function printTreeNavigation($folderid, $showtree){ /* begin function */
		if ($showtree==1){
...
<?php
	...
	function printClipboard($clipboard){ /* begin function */
		$dms = $this->params['dms'];   
...
//		print_r($clipboard);
	 ...
	 */
	function printUploadApplet($uploadurl, $attributes, $maxfiles=0, $fields=array()){ /* begin function */
?>
