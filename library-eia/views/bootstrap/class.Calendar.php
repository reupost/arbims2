...
class SeedDMS_View_Calendar extends SeedDMS_Bootstrap_Style {
	...
	function generateCalendarArrays() { /* begin function */
	...
	function getDaysInMonth($month, $year) { /* begin function */
	...
	function adjustDate(&$day,&$month,&$year) { /* begin function */
	...
	function getMonthHTML($month, $year) { /* begin function */
	...
	function printYearTable($year) { /* begin function */
