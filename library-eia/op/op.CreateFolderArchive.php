 ...
 *        be followed by '/'
 */
function TarAddHeader($f,$phisfn,$archfn) { /* begin function */
    $info=@stat($phisfn);
		if($info === false)
			return false;
...
// phisfn: path to file
// code by calmarius at nospam dot atw dot hu
function TarWriteContents($f,$phisfn) { /* begin function */
...
// f: file resource
// code by calmarius at nospam dot atw dot hu
function TarAddFooter($f) { /* begin function */
    fwrite($f,pack('a1024',''));
} /* end function */

// thanks to Doudoux
function getFolderPathPlainAST($folder) { /* begin function */
    $path="";
...
function createFolderTar($folder,$ark) { /* begin function */
