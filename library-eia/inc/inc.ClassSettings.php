...
class Settings { /* begin function */
    ...
    //RR added for override path to language files
    var $_sharedLangPath = "";
	 ...
	 */
	function Settings($configFilePath='') { /* begin function */
		if($configFilePath=='') {
	 ...
	 * @return true/false
	 */
	function boolVal($var) { /* begin function */
	 ...
	 *
	 */
  function setViewOnlineFileTypesFromString($stringValue) { /* begin function */
	 ...
	 *
	 */
  function getViewOnlineFileTypesToString() { /* begin function */
	 ...
	 * @return true/false
	 */
	function load($configFilePath) { /* begin function */
        ...
        if (isset($tab["sharedLangPath"])) //RR added
            $this->_sharedLangPath = strval($tab["sharedLangPath"]); //RR added
        else
            $this->_sharedLangPath = "";
	 ...
	 * @return true/false
	 */
  function setXMLAttributValue($node, $attributName, $attributValue) { /* begin function */
	 ...
	 */
	function getXMLNode($rootNode, $parentNodeName, $name) { /* begin function */
	 ...
	 * @return true/false
	 */
	function save($configFilePath=NULL) { /* begin function */
    ...
    $this->setXMLAttributValue($node, "sharedLangPath", $this->_sharedLangPath); //RR added
	 ...
	 */
	function searchConfigFilePath() { /* begin function */
		$configFilePath = null;
	 ...
	 */
	function getConfigDir() { /* begin function */
	 ...
	 * @return string
	 */
	function curPageURL() { /* begin function */
	  $pageURL = 'http';
	 ...
	 */
	function findInIncPath($file) { /* begin function */
	 ...
	 *  @return array
	 */
	function check($minversion) { /* begin function */
		// suggestion rootdir
	 ...
	 *
	 */
	function checkSystem() { /* begin function */
		// result
		$result = array();
