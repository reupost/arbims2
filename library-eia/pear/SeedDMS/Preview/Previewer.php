...
class SeedDMS_Preview_Previewer {
	 ...
	 */
	protected function getFileName($object, $width) { /* end function */
	...
	public function createPreview($object, $width=0) { /* begin function */
		if($width == 0)
			$width = $this->width;
		else
			$width = intval($width);
	...
	public function hasPreview($object, $width=0) { /* begin function */
		if($width == 0)
			$width = $this->width;
		else
			$width = intval($width);
	...
	public function getPreview($object, $width=0) { /* begin function */
		if($width == 0)
			$width = $this->width;
		else
			$width = intval($width);
	...
	public function deletePreview($document, $object, $width=0) { /* begin function */
		if($width == 0)
			$width = $this->width;
		else
			$width = intval($width);
