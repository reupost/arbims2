...
class SeedDMS_View_ManageNotify extends SeedDMS_Bootstrap_Style {
	...
	function getNotificationList($as_group, $folders) { /* begin function */
	...
	function printFolderNotificationList($ret,$deleteaction=true) { /* begin function */
		if (count($ret)==0) {
	...
	function printDocumentNotificationList($ret,$deleteaction=true) { /* begin function */
