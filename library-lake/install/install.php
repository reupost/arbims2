 ...
 * Functions
 */
function openDBConnection($settings) { /* begin function */
...
function printError($error) { /* begin function */
...
function printWarning($error) { /* begin function */
...
function printCheckError($resCheck) { /* begin function */
	$hasError = false;
...
function fileExistsInIncludePath($file) { /* begin function */
 ...
 */
if (isset($_GET['disableinstall'])) { /* begin function */
	if(file_exists($configDir."/ENABLE_INSTALL_TOOL")) {
 ...
 * Check System
 */
if (printCheckError( $settings->checkSystem())) { /* begin function */
