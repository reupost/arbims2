...
function insert_user($user) { /* begin function */
	global $dms;
...
function insert_group($group) { /* begin function */
	global $dms, $users;
...
function insert_attributedefinition($attrdef) { /* begin function */
	global $dms;
...
function insert_documentcategory($documentcat) { /* begin function */
	global $dms;
...
function insert_keywordcategory($keywordcat) { /* begin function */
	global $dms;
...
function insert_document($document) { /* begin function */
	global $dms;

	print_r($document);
} /* end function */

function insert_folder($folder) { /* begin function */
	print_r($folder);
} /* end function */

function startElement($parser, $name, $attrs) { /* begin function */
...
function endElement($parser, $name) { /* begin function */
...
function characterData($parser, $data) { /* begin function */
	global $elementstack, $cur_user, $cur_group, $cur_folder, $cur_document, $cur_version, $cur_approval, $cur_review, $cur_attrdef, $cur_documentcat, $cur_keyword, $cur_keywordcat;
