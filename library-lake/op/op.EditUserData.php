...
$comment  = isset($_POST["comment"])? $_POST["comment"] : $user->getComment();
$language  = $_POST["language"];
$mytheme  = 'bootstrap'; //$_POST["theme"];
$current_pwd  = isset($_POST["currentpwd"])? $_POST["currentpwd"] : "";
$bulletin = $_POST["bulletin"]; //RR added

if (!$user->isLinkedAccount()) { //RR added - linked account holders won't enter a password
