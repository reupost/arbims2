...
class HTTP_WebDAV_Server_SeedDMS extends HTTP_WebDAV_Server
{
	 ...
	 */
	function ServeRequest($dms = null, $logger = null) /* begin function */
	{
	 ...
	 * @param  array  options
	 */
	function log_options($methode, $options) { /* begin function */
		if($this->logger) {
	 ...
	 */
	function check_auth($type, $user, $pass) /* begin function */
	{
		if($this->logger)
	 ...
	 */
	function reverseLookup($path) /* begin function */
	{
	 ...
	 */
	function PROPFIND(&$options, &$files) /* begin function */
	{
	 ...
	 */
	function fileinfo($obj) /* begin function */
	{
		// create result array
		$info = array();
		$info["props"] = array();
...
//			$info["path"] = htmlspecialchars($path.rawurlencode($obj->getName()));
	 ...
	 * @return bool   true on success
	 */
	function GET(&$options) /* begin function */
	{
	 ...
	 */
	function GetDir($folder, &$options) /* begin function */
	{
...
//			$name	 = htmlspecialchars($filename);
	 ...
	 * @return bool   true on success
	 */
	function PUT(&$options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function MKCOL($options) /* begin function */
	{		   
	 ...
	 * @return bool   true on success
	 */
	function DELETE($options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function MOVE($options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function COPY($options, $del=false) /* begin function */
	{
		if(!$del)
	 ...
	 * @return bool   true on success
	 */
	function PROPPATCH(&$options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function LOCK(&$options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function UNLOCK(&$options) /* begin function */
	{
	 ...
	 * @return bool   true on success
	 */
	function checkLock($path) /* begin function */
	{
		if($this->logger)
