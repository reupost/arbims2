...
<?php		$this->contentContainerStart(); ?>
    <table class="table-condensed">
      ...
      <!-- RR added -->
      <tr title="<?php printMLText("settings_sharedLangPath_desc");?>">
        <td><?php printMLText("settings_sharedLangPath");?>:</td>
        <td><input type="text" name="sharedLangPath" value="<?php echo $settings->_sharedLangPath ?>" /></td>
      </tr>
      <!-- RR added end -->
