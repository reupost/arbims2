...
<?php
		...
		if($user->isAdmin()) {
			...
			$this->contentContainerStart();	//RR moved
			echo "<table class=\"table-condensed\">\n"; //RR moved from above
			echo "<tr>";
			echo "<td>".getMLText("id").":</td>\n";
			echo "<td>".htmlspecialchars($folder->getID())."</td>\n";
			echo "</tr>";
		//} //RR removed to minimise folder info for non-admin users
			echo "<tr>";
...
<?php
			...
			if($subFolder->getAccessMode($user) > M_READWRITE) { /* RR was >= */
?>
