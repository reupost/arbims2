...
?>
        ...
        <tr>
            ...
            <td><input type="checkbox" name="isbulletin" value="1" checked="checked"></td>
        </tr>
        <tr>
            <td><?php printMLtext("linked_account") ?>?</td>            
            <td><input type="checkbox" name="islinkedaccount" value="1" disabled='disabled'></td>
        </tr>
...
?>
                <tr>
                    <td><?php printMLtext("master_moderator") ?>?</td>            
                    <td><input type="checkbox" name="ismastermoderator" value="1" disabled="disabled"></td>
                </tr>
<?php
...
?>
        ...
        <tr>
			<td><?php printMLText("bulletin");?>:</td>
			<td><input type="checkbox" name="isbulletin" value="1"<?php print ($currUser->isBulletin() ? " checked='checked'" : "");?>></td>
		</tr>
		<tr>
			<td><?php printMLText("linked_account");?>:</td>
			<td><input type="checkbox" name="islinkedaccount" value="1"<?php print ($currUser->isLinkedAccount() ? " checked='checked'" : "");?> disabled='disabled'></td>
		</tr>
...
?>
		...
		<tr>
			...
			<td><input type="file" name="userfile" accept="image/jpeg"></td>
                ...
                <tr>
                    <td><?php printMLText("master_moderator");?>:</td>
                    <td><input type="checkbox" name="ismastermoderator" value="1"<?php print ($currUser->isMasterModerator() ? " checked='checked'" : "");?> <?php print ($currUser->isAdmin()? "" : " disabled='disabled'" ) ?>></td>
		</tr>
<?php
		}
		if($workflowmode == "traditional") {
