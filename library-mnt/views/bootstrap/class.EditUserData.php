...
<?php
        ...
        $is_linked_account = $user->isLinkedAccount();
?>
...
<table class="table-condensed">
    ...
    <tr>
        <td colspan="2">
            <?php printMLText("linked_account_note");?>
        </td>
    </tr>
    <?php } ?>
	<tr>
		<td><?php printMLText("current_password");?>:</td>
		<td><input id="currentpwd" type="password" name="currentpwd" size="30" <?php if ($is_linked_account) echo " disabled='disabled'" ?>></td>
	</tr>
	<tr>
		<td><?php printMLText("new_password");?>:</td>
		<td><input class="pwd" type="password" rel="strengthbar" name="pwd" size="30" <?php if ($is_linked_account) echo " disabled='disabled'" ?>></td>
	</tr>
<?php
        if($passwordstrength) {
?>
...
?>
	<tr>
		...
		<td><input id="pwdconf" type="Password" name="pwdconf" size="30" <?php if ($is_linked_account) echo " disabled='disabled'" ?>></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="email" value="<?php print htmlspecialchars($user->getEmail());?>" size="30" <?php if ($is_linked_account) echo " disabled='disabled'" ?>></td>
	</tr>
	<tr>
    ...
    <?php /* //RR added */ ?>
    <tr>
        <td><?php printMLtext("bulletin") ?>?</td>
        <td>
            <select name="bulletin">
                <option value="0" <?php echo (!$user->isBulletin()? "selected" : "") ?>><?php printMLtext("no") ?></option>
                <option value="1" <?php echo ($user->isBulletin()? "selected" : "") ?>><?php printMLtext("yes") ?></option>
			</select>
        </td>
    </tr>
