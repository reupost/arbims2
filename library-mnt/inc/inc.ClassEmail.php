...
class SeedDMS_Email extends SeedDMS_Notify {
	...
	function toIndividual($sender, $recipient, $subject, $message, $params=array()) { /* begin function */
		global $settings;
	...
	function toGroup($sender, $groupRecipient, $subject, $message, $params=array()) { /* begin function */
		if ((!is_object($sender) && strcasecmp(get_class($sender), "SeedDMS_Core_User")) ||
	...
	function toList($sender, $recipients, $subject, $message, $params=array()) { /* begin function */
		if ((!is_object($sender) && strcasecmp(get_class($sender), "SeedDMS_Core_User")) ||
	...
	function sendPassword($sender, $recipient, $subject, $message) { /* begin function */
		global $settings;
