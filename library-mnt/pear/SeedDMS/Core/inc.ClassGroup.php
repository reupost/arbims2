...
class SeedDMS_Core_Group {
	...
	function SeedDMS_Core_Group($id, $name, $comment) { /* begin function */
		$this->_id = $id;
		$this->_name = $name;
	...
	function getManagers() { /* begin function */
		$db = $this->_dms->getDB();
	...
	function addUser($user,$asManager=false) { /* begin function */
		$db = $this->_dms->getDB();
	...
	function removeUser($user) { /* begin function */
		$db = $this->_dms->getDB();
	...
	function isMember($user,$asManager=false) { /* begin function */
	...
	function toggleManager($user) { /* begin function */
		$db = $this->_dms->getDB();
	 ...
	 */
	function remove($user) { /* begin function */
		$db = $this->_dms->getDB();
